...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item mr-sm-3 mb-2 mb-sm-0">
                        <div class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton"
                                ...
                                <?php echo app('translator')->get('landing.langtext'); ?>
                            </button>
                    ...
                    <li class="nav-item">
                        <a class="btn btn-success" href="<?php echo e(url('login')); ?>"><?php echo app('translator')->get('landing.loginOrRegister'); ?></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header class="bg-blue py-5">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-3 text-white mt-5 mb-2"><?php echo app('translator')->get('landing.welcome'); ?></h1>
                    <p class="lead mb-5 text-white-50"><?php echo app('translator')->get('landing.tagline'); ?></p>
                </div>
                <div class="col-lg-6">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; <?php echo e(config('app.name')); ?> 2020</p>
        </div>
        <!-- /.container -->
    </footer>
...
</html><?php /**PATH D:\kirana\o\app-laundry\resources\views/landing.blade.php ENDPATH**/ ?>